...
<body>
    ...
    <form id="formlist" action="write.php" method="post">
        ...
        出展日: <input type="date" name="date" class="feedback-input">
        出展場所: <input type="text" name="address" class="feedback-input">
        出展予定の作品および点数: <textarea name="text" class="feedback-input"></textarea> <!-- おおきく -->
        パスワード: <input type="password" name="password" placeholder="パスワードを入力" class="feedback-input">
